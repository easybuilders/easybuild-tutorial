...
been visited in the last year (June 1st 2020 - June 1st 2021), and how often.
...
!!! Note
    A dedicated [`#tutorial-isc21` channel](https://easybuild.slack.com/archives/C024XFGPC8G) was created for this tutorial in the EasyBuild Slack.
