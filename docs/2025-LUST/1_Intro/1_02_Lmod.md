...
Unloading the environment module will try to restore the shell environment to its previous state.
...
developed [Environment Modules 4 and 5](https://envmodules.github.io/modules/) which is
