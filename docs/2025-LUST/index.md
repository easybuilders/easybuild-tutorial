...
and has been developed for the LUMI User Support Team, based on a version developed
for CSC and the Local Organisations within the LUMI consortium. Yet
...
-   Python 3.6+, though a fairly recent version of Python 3 (3.9 or higher) is highly recommended,
